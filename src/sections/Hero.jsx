...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="hero-photo-shape absolute inset-y-0 right-0 hidden w-[56%] overflow-hidden lg:block">
        <img
          src={marileiPhoto}
          width="851"
          height="1280"
      ...
      <Container className="relative z-10 grid lg:min-h-[calc(100svh-92px)] lg:grid-cols-[60%_40%]">
        <div className="flex flex-col justify-center pb-12 pt-16 lg:py-16 lg:pr-16">
          <div className="">
            ...
            <p className="max-w-[580px] text-lg leading-8 text-olive-900/85 sm:text-xl">
              Nem todo sofrimento emocional tem a mesma origem. Um tratamento
              eficaz começa pela compreensão cuidadosa de cada história.
            </p>
          ...
          <div className="mt-9 max-w-[730px] rounded-2xl border border-white/80 bg-white/75 px-6 py-6 shadow-soft backdrop-blur sm:flex sm:items-center sm:gap-6">
        ...
        <div className="relative h-[650px] overflow-hidden lg:hidden">
